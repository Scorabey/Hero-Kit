...
const styledColor = {
    default: (theme: ThemeType, variant: BadgeVariant) => css`
        background-color: ${variant === "faded" ? theme.colors.base["default-100"] : variant === "flat" ? theme.colors.flat["default-flat"] : theme.colors.base.default};
    ...
    primary: (theme: ThemeType, variant: BadgeVariant) => css`
        background-color: ${variant === "faded" ? theme.colors.base["default-100"] : variant === "flat" ? theme.colors.flat["primary-flat"] : theme.colors.base.primary};
    ...
    secondary: (theme: ThemeType, variant: BadgeVariant) => css`
        background-color: ${variant === "faded" ? theme.colors.base["default-100"] : variant === "flat" ? theme.colors.flat["secondary-flat"] : theme.colors.base.secondary};
    ...
    warning: (theme: ThemeType, variant: BadgeVariant) => css`
        background-color: ${variant === "faded" ? theme.colors.base["default-100"] : variant === "flat" ? theme.colors.flat["warning-flat"] : theme.colors.base.warning};
    ...
    success: (theme: ThemeType, variant: BadgeVariant) => css`
        background-color: ${variant === "faded" ? theme.colors.base["default-100"] : variant === "flat" ? theme.colors.flat["success-flat"] : theme.colors.base.success};
    ...
    danger: (theme: ThemeType, variant: BadgeVariant) => css`
        background-color: ${variant === "faded" ? theme.colors.base["default-100"] : variant === "flat" ? theme.colors.flat["danger-flat"] : theme.colors.base.danger};
